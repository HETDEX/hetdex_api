...
def get_cal_table(calfile):
    ...
    cal_table = Table(
        [cal_f[0].data, cal_f[1].data, cal_f[2].data, cal_f[3].data, cal_f[4].data],
        names=["calfib", "calfibe", "calfib_counts", "calfibe_counts", "calfib_ffsky"],
    )
    ...
    for calfile in calfiles:
        ...
        for amp_i in ["LL", "LU", "RL", "RU"]:
            ...
            for fibrow in fibtable.where("multiframe == multiframe_i"):
                ...
                idx = (
                    (cal_table["expnum"] == fibrow["expnum"])
                    * (cal_table["multiframe"] == fibrow["multiframe"].decode())
