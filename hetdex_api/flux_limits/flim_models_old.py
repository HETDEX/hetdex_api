...
Store the old deprecated flux limit
models that were not used in papers

"""

from numpy import polyval

def hdr1_f50_from_noise(noise, lambda_, sncut):
    """
...
def hdr2pt1_f50_from_noise(noise, lambda_, sncut):
    """
    Return the 50% completeness
    flux given noise and 
...
def snmode_f50_from_noise(noise, lambda_, sncut):
    """
    Return the 50% completeness
    flux given noise and 
    S/N cut. This just assumes
