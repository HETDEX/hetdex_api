...
class DetWidget():
    def __init__(self):
        ...
        col3 = widgets.VBox([linewidth_label, self.linewidth_low, self.linewidth_high])
        ...
        self.toggles = widgets.HBox([textcol,col1, col2, col3, col4, col5, col6])
        self.button = widgets.Button(description="Select Detections", button_style='success')
