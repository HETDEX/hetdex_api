...
#awk '{print "python3 /work/05350/ecooper/stampede2/hetdex_api/hetdex_tools/get_det_flags.py", $1$2}' /scratch/03946/hetdex/hdr4/survey/hdr4.use > run_get_det_flags  
#survey = "hdr3"
survey = "hdr4"
